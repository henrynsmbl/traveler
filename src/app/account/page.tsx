  ...
  return (
    <RequireAuth>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex justify-center">
        <div className="w-full max-w-4xl px-4 pt-20 pb-12 sm:py-24">
          ...
          {/* Profile Section */}
          <div className="bg-white dark:bg-gray-800 sm:bg-white/80 sm:dark:bg-gray-800/80 sm:backdrop-blur-lg rounded-3xl border border-gray-100 dark:border-gray-700 p-6 mb-6 shadow-xl max-w-2xl mx-auto">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-white break-all">
                  {user.email}
                </h2>
          ...
          <div className="bg-white dark:bg-gray-800 sm:bg-white/80 sm:dark:bg-gray-800/80 sm:backdrop-blur-lg rounded-3xl border border-gray-100 dark:border-gray-700 p-6 shadow-xl max-w-2xl mx-auto">
            ...
            {loading ? (
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="rounded-xl p-4 text-center">
                    <p className="text-base font-medium text-gray-900 dark:text-white mb-2">Status</p>
                  ...
                  <div className="rounded-xl p-4 text-center">
                    <p className="text-base font-medium text-gray-900 dark:text-white mb-2">Next Payment</p>
                ...
                <div className="flex justify-center pt-4">
                  <button
                    ...
                    className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-2"
                  >
              ...
              <div className="text-center space-y-6">
                ...
                <Link
                  href="/subscription"
                  className="inline-flex px-6 py-2.5 bg-gradient-to-r from-blue-600 to-purple-500 text-white rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
                  View Plans
                </Link>
              </div>
